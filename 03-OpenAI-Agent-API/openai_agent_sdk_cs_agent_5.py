...
PDF_PATH = "./1_foundations/me/new_india_assurance.pdf"
...
async def rag_invoker(tool_context, params):
    ...
    if best_chunk:
        # --- Generation step: summarize/answer using LLM ---
...
rag_tool = FunctionTool(
    name="get_pdf_answer",
    description="Answers questions by retrieving relevant information from the PDF and generating a concise answer.",
...
with gr.Blocks() as demo:
    gr.Markdown("# Customer Support Bot (RAG + Generation)")
